...
public class DeezerAudioTrack extends ExtendedAudioTrack {
	...
	public JioSaavanAudioTrack(AudioTrackInfo trackInfo, JioSaavanAudioSourceManager sourceManager) {
		this(trackInfo, null, null, null, null, null, false, sourceManager);
	}

	public JioSaavanAudioTrack(AudioTrackInfo trackInfo, String albumName, String albumUrl, String artistUrl, String artistArtworkUrl, String previewUrl, boolean isPreview, JioSaavanAudioSourceManager sourceManager) {
